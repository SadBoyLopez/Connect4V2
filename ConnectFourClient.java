    ...
    implements ConnectFourConstants, Runnable
{
    ...
    /**
    * Notifies Session whether or not the user wants to play again
    * @param answer  the answer the player has chosen
    */
    public void playAgain(int answer) throws IOException
    {
