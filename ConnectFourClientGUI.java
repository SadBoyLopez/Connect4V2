...
//
// This is the GUI for connect four
    ...
    public void update(Observable o, Object obj)
    {
        ...
        if (obj instanceof String)
        {
            ...
            if (text.contains("won"))
            {
                ...
                {
                    playerOneScore++;
                    player1ScoreLabel.setText("Player 1\'s score : "
                        + playerOneScore);
                }
                else
                {
                    playerTwoScore++;
                    player2ScoreLabel.setText("Player 2\'s score : "
                        + playerTwoScore);
                }
                restartGame();
            }
