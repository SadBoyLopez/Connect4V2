    ...
    public void run()
    {
        try
        {
            ...
            do{
                ...
                int player1Answer = fromPlayer1.readInt();
                int player2Answer = fromPlayer2.readInt();

                if (player1Answer == YES_PLAY && player2Answer == YES_PLAY)
                {
                    playAgain = true;
                    theBoard.resetBoard();
                    toPlayer1.writeInt(YES_PLAY);
                    toPlayer2.writeInt(YES_PLAY);
                }
                else
                {
                    toPlayer1.writeInt(NO_PLAY);
                    toPlayer2.writeInt(NO_PLAY);
                }
